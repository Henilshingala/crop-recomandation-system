"""
Real predictor V4 - Uses 11 features with proper scaling.
"""
...
class RealPredictorV4:
    ...
    def predict(
        ...
        season = season if season is not None else infer_season(temperature)
        proba = self._get_proba(N, P, K, temperature, humidity, ph, rainfall, season, soil_type, irrigation, moisture)
